...
public class Ejercicio_1 {
    ...
    public static void main(String[] args) {
        ...
        String fechaNacimiento = entrada.nextLine(); // Leer entrada del usuario
        String[] partes = fechaNacimiento.split("/"); // Dividir la fecha
        int dia = Integer.parseInt(partes[0]); // Convertir a entero
        int mes = Integer.parseInt(partes[1]); // Convertir a entero
